...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "NUD " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
    0x8c8d1567, 0x71e58368, 0xf7acaa6b, 0xe0179e72, 0x2c9ca073,
    0x965f1b74, 0x461f7fa4, 0x09559bc0, 0xabd99ac3, 0x9beec3cb,
    0x43f0c3cb, 0x2955482e, 0xbbd0e705, 0xad36b33c, 0xa9a3753e,
    0xf2d9d23e, 0x2b9d835d
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. NUD is probably already running."), addrBind.ToString().c_str());
        else
